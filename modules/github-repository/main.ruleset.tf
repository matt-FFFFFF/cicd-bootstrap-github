resource "github_repository_ruleset" "this" {
  ...
  lifecycle {
    precondition {
      condition     = data.github_organization.this.plan != local.plan.free && var.visibility == "private"
      error_message = "The GitHub repository ruleset requires a Pro or Enterprise plan."
    }
  }
